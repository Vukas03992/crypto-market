...
data class FiatProperties(override val name: String, override val symbol: String, override val isoCode: String, override val ticker: Ticker): BaseFiatCurrency.Properties
